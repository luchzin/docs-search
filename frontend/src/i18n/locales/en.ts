const documents = {
  dropzoneTitle: "Drop documents here or click to upload",
  dropzoneSub: "Supports PDF, DOCX, TXT, MD, CSV, JSON files up to 20MB",
  pdfOnly: "PDF, DOCX, TXT, MD, CSV, JSON",
  supportedFormats: "PDF, DOCX, TXT, MD, CSV, JSON",
  onlyPdfSupported: "Only PDF, DOCX, TXT, MD, CSV, JSON, and LOG files are supported",
...
export default {
  ...
  chat: {
    ...
    uploadPrompt: "Upload a document to begin asking questions",
    noDocumentsFound: "No document chunks available. Upload a document first.",
    sourcesUsed: "Sources Used",
    userRole: "You",
    assistantRole: "DocsSearch AI",
    welcomeTitle: "Welcome to DocsSearch AI",
    welcomeSub: "Upload documents (PDF, DOCX, TXT, MD, CSV, JSON) and ask questions to retrieve precise, AI-generated answers with source citations.",
    startUploadNotice: "Please upload at least one document in the sidebar to start asking questions.",
